<template>
    <div
        v-if="props.submission && modSubmissionsListStore.selectedModerationListViewChosen
            ...
            >
                <div class="flex items-center">
                    <span class="font-bold text-primary-text-muted">
                        # {{ props.paginationGlobalRowValueFunction(currentPage, itemsPerPage, index) }}
                    </span>
...
const props = defineProps<{ submission: Submission
    paginationGlobalRowValueFunction: (page: number, perPage: number, index: number) => number
    currentPage: number
    itemsPerPage: number
    index: number }>()
