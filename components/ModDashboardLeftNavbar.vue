<template>
    <div>
        <select class="font-bold border-b border-black mb-2">
        ...
        <div class="flex flex-col">
            <div class="flex flex-row w-4/5 justify-start items-center border-b-2 border-slate-200">
                <SVGNoteStackAddSvg class="h-4" />
                <button @click="updateSubmissionListViewState('forReview')"
            ...
            <div class="flex flex-row w-4/5 justify-start items-center border-b-2 border-slate-200">
                ...
                <button @click="updateSubmissionListViewState('approved')"
                    class="flex flex-row items-center text-start p-1 ">
            ...
            <div class="flex flex-row w-4/5 justify-start items-center ">
                ...
                <button @click="updateSubmissionListViewState('rejected')"
                    class="flex flex-row items-center text-start p-1">
