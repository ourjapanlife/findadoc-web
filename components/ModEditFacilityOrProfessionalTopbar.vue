...
const healthcareProfessionalHasUnsavedChanges = () => {
    ...
    console.log(originalHealthcareProfessional.acceptedInsurance)
    console.log(healthcareProfessionalSections.acceptedInsurance)
...
watch(() => healthcareProfessionalsStore.selectedHealthcareProfessionalData, newValue => {
    originalHealthcareProfessionalRefsValue.value = newValue
})
</script>
