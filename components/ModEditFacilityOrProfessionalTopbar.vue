...
import type { Degree, Facility, HealthcareProfessional, Insurance, Locale, Specialty } from '~/typedefs/gqlTypes'
...
type ComparableArray = Insurance[] | Locale[] | Degree[] | Specialty[] | string[]

//This is a helper function that sorts and compares that all the values in a primitive value array are equal
const arraysAreEqual = (array1: ComparableArray,
    array2: ComparableArray) => {
...
const facilityHasUnsavedChanged = () => {
...
const hasUnsavedChanges = () => {
    if (moderationScreenStore.activeScreen === ModerationScreen.EditFacility) {
        return facilityHasUnsavedChanged()
    }
