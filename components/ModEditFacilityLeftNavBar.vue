    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-col items-start">
            <button
                ...
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.ContactInformation)"
            >
            ...
            <button
                ...
                class="w-full py-4 my-2 text-sm text-start pl-2 rounded border-b-2 border-tertiary-bg"
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.Addresses)"
            >
            ...
            <button
                ...
                class="w-full py-4 my-2 text-sm text-start pl-2 rounded border-b-2 border-tertiary-bg"
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.GoogleMapsInformation)"
            >
            ...
            <button
                ...
                class="w-full py-4 my-2 text-sm text-start pl-2 rounded border-b-2 border-tertiary-bg"
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.HealthcareProfessionalIds)"
            >
            ...
            <button
                ...
                class="w-full py-4 my-2 text-sm text-start pl-2 rounded border-b-2 border-tertiary-bg"
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.HealthcareProfessionalToAdd)"
            >
            ...
            <button
                ...
                :class="{ 'bg-secondary': activeSection
                          ...
                          'bg-primary-inverted': activeSection
                              !== ModEditFacilityLeftBarSectionIDs.CurrentHealthcareProfessionalsAtFacility }"
                class="w-full py-4 my-2 text-sm text-start pl-2 rounded border-b-2 border-tertiary-bg"
                @click="scrollToSectionOfForm(ModEditFacilityLeftBarSectionIDs.CurrentHealthcareProfessionalsAtFacility)"
            >
