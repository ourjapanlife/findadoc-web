<template>
  <div class="flex flex-col bg-gray-800 p-12 w-full">
    <div class="md:w-1/2">
      ...
      >
        <img
          class="w-3/4 mb-8 rounded-2xl shadow-2xl"
          src="../assets/images/homepage/findadoc-boostershot-wiki.png"
          alt=""
        />
      </div>
      <span class="text-lg text-gray-300">
        Members of the international community are working together to collect
        and share booster shot information in Japan. We've created a wiki that
        anyone in the community can edit and contribute to.✨
      </span>
    </div>
    <div>
