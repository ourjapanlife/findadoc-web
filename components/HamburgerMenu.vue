<template>
    <div class="cursor-pointer w-full flex" v-close-on-outside-click>
        ...
        <div id="hamburger-menu" v-show="isMenuOpen"
            class="z-20 absolute top-0 left-0 h-full w-2/3 pt-6 pb-8 rounded bg-primary-bg border-2 flex flex-col justify-between">
            <div id="upper-section">
                ...
                <div id="language-section" class="flex mt-2 px-5">
                    <span class="text-primary-text self-center mr-2">{{ $t('hamburgerMenu.languageDropdownTitle') }}</span>
