...
const setChosenLocaleNameInput = (index: number) => {
    ...
    = submissionFormFields.healthCareProfessionalNameArray.find((_, index) => index === chosenLocaleIndex.value)
    ...
    = chosenHealthcareProfessionalToEdit.value
        ...
        submissionFormFields.healthCareProfessionalNameArray[chosenLocaleIndex.value]
